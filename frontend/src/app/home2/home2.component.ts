...
export class Home2Component implements OnInit {
  ...
  ngOnInit() {
    ...
    this.homeService.getUserdata().subscribe(data =>{
      this.userdata = data;
      // this.mypic = this.userdata[0]["tPicture"];
